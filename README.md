[![Stars](https://img.shields.io/github/stars/RanaAhmar/huggingface-cli-tools?style=for-the-badge)](https://github.com/RanaAhmar/huggingface-cli-tools/stargazers) [![Issues](https://img.shields.io/github/issues/RanaAhmar/huggingface-cli-tools?style=for-the-badge)](https://github.com/RanaAhmar/huggingface-cli-tools/issues) [![MIT License](https://img.shields.io/badge/License-MIT-green.svg?style=for-the-badge)](https://github.com/RanaAhmar/huggingface-cli-tools/blob/main/LICENSE)

# 📦 HuggingFace CLI Tools

Manage your HuggingFace assets directly from the terminal. Download models, upload datasets, and monitor spaces. By **Ahmar Hussain** (**Stackaura**).

## 🚀 CLI Commands
- `hf-cli download model_id`
- `hf-cli upload dataset_path`
